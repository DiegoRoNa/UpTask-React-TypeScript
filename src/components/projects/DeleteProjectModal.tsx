...
export default function DeleteProjectModal() {
    ...
    const deleteProjectId = Number(queryParams.get('deleteProject'))
    ...
    const handleForm = async (formData : CheckPasswordForm) => {
        await checkUserPasswordMutation.mutateAsync(formData) // version async de mutate
                            ...
                            <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                ...
                                <form className="mt-10 space-y-5" onSubmit={handleSubmit(handleForm)} noValidate>
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <input id="password" type="password" placeholder="Contraseña Inicio de Sesión"
