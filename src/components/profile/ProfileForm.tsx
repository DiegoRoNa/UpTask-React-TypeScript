            ...
            <div className="mx-auto max-w-3xl g">
                ...
                <form onSubmit={handleSubmit(handleEditProfile)} className=" mt-14 space-y-5  bg-white shadow-lg p-10 rounded-l" noValidate>
                    <div className="mb-5 space-y-3">
                        ...
                        <input id="name" type="text" placeholder="Tu Nombre" className="w-full p-3  border border-gray-200"
                            {...register("name", {
                    ...
                    <div className="mb-5 space-y-3">
                        <label className="text-sm uppercase font-bold" htmlFor="text">Correo</label>
                        <input id="text" type="email" placeholder="Tu correo electrónico" className="w-full p-3  border border-gray-200"
                            {...register("email", {
