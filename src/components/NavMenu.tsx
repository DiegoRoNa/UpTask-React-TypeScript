...
export default function NavMenu({name} : NavMenuProps) {
    ...
    return (
        <Popover className="relative mr-7">
            ...
            <Transition as={Fragment} enter="transition ease-out duration-200" enterFrom="opacity-0 translate-y-1"
                ...
                <Popover.Panel className="absolute left-1/2 z-10 mt-5 flex w-screen lg:max-w-min -translate-x-1/2 lg:-translate-x-48">
                    <div className="w-full lg:w-56 shrink rounded-xl bg-white p-4 text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
                        ...
                        <button onClick={logout} className="block p-2 hover:text-purple-950" type="button">
                            Cerrar Sesión
                        </button>
